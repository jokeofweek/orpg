...
public final class Constants {
	...
	// General use
	public static final int[] TWO_POWERS = new int[] { 1, 2, 4, 8, 16, 32,
			64, 128 };

	// Data path options
	public static final String CLIENT_DATA_PATH = "data/client/";
	public static final String CLIENT_ASSETS_PATH = CLIENT_DATA_PATH
			+ "gfx/";
	public static final String EDITOR_DATA_PATH = "data/editor/";
	public static final String SERVER_DATA_PATH = "data/server/";
	public static final String SERVER_MAPS_PATH = SERVER_DATA_PATH
			+ "maps/";
	public static final String SERVER_ACCOUNTS_PATH = SERVER_DATA_PATH
			+ "accounts/";
	public static final String SERVER_LOGS_PATH = SERVER_DATA_PATH
			+ "logs/";
	...
	public static final int TILES_PER_TILESET = TILESET_WIDTH
			* TILESET_HEIGHT;
	...
	public static final int SPRITE_WIDTH = SPRITE_FRAME_WIDTH
			* SPRITE_FRAMES;
