...
public class MapEditorApplication implements Application {
	...
	public static void main(String[] args) {
		DesktopApplicationContext.main(MapEditorApplication.class, args);
	}
